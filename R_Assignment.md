...
Please send them the url address of the GitHub (public) repository you've created **by 11:59pm on Friday, March 13**. 
CC me on your email.
...
Push your review to the forked repository and submit a Pull request **by 1pm on Monday, March 23**. 
...
Finally, submit your assignment in Canvas **by 1pm on Wednesday, March 25**.
...
* There will be significant time involved in completing this assignment, especially if you are new to R. 
  ...
  **Important: Do not use AI to generate the code!** 
  This would defeats the purpose of the class.
  Also, while you can ask for help/advice from other students, **the work should be your own** (including the code and interpretation of the results)!
...
Also provide a brief description of the variables in each dataset.
...
* In order to join these files, you may need to transpose your genotype data so that the columns become rows.  
  ...
  However, check the results carefully, as there could be surprises (remember, matrix is a homegeneous data structure!);)
...
* Again, do not use AI to generate your code!
